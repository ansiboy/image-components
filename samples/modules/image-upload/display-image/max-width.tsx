...
export default class ImageUploadPage extends React.Component<{}, State> {
    ...
    render() {
        ...
        return <div className="container">
            <br />
            <label>固定大小</label>
            <pre>{`<ImageUpload saveImage={(data) => this.uploadImage(data.base64)} displayImage={{ maxWidth: 200 }} />`}</pre>
            <ImageUpload saveImage={(data) => this.uploadImage(data.base64)} displayImage={{ maxWidth: 200 }} />
            <hr />
            {messageElement}
        </div>;
